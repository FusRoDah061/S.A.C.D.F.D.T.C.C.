	...
	*/
	funcao calcula_ferro(real perimetro, real profundidade, real altura, inteiro qtde_colunas, real largura_baldrame, real profundidade_baldrame)
	{
		...
		faca{
			...
			escreva("Digite o espaçamento entre as amarraç?es do estribo: ")
			leia(espacamento)
	...
	funcao salvar_dados()
	{
		...
		faca{
			...
			//Telhas
				...
				valor = Tipos.real_para_cadeia(g_custo_total)
				...
				valor = Tipos.real_para_cadeia(g_preco_unit)
			...
			//Telhado
				...
				valor = Tipos.real_para_cadeia(g_largura_base)
				...
				valor = Tipos.real_para_cadeia(g_comprimento_base)
				...
				valor = Tipos.real_para_cadeia(g_area_telhado_corrigida)
			...
			//Madeiramento
				...
				valor = Tipos.real_para_cadeia(g_metragem_pontaletes)
				...
				valor = Tipos.real_para_cadeia(g_metragem_caibros)
				...
				valor = Tipos.real_para_cadeia(g_metragem_ripas)
				...
				valor = Tipos.real_para_cadeia(g_metragem_tercas)
				...
				valor = Tipos.real_para_cadeia(g_tercas_espacamento)
				...
				valor = Tipos.real_para_cadeia(g_comprimento_garga)
			...
			//Tijolos
				...
				valor = Tipos.real_para_cadeia(g_qtde_tijolo_metro_quadrado)
				...
				valor = Tipos.real_para_cadeia(g_custo_total_tijolos)
				...
				valor = Tipos.real_para_cadeia(g_preco_unit_tijolo)
			...
			//Revestimento
				...
				valor = Tipos.real_para_cadeia(g_qtde_total_revestimento)
				...
				valor = Tipos.real_para_cadeia(g_qtde_revestimento_metro_quadrado)
				...
				valor = Tipos.real_para_cadeia(g_custo_total_revestimento)
				...
				valor = Tipos.real_para_cadeia(g_preco_unit_revestimento)
			...
			//Tinta
				valor = Tipos.real_para_cadeia(g_qtde_total_galoes_tinta)
				...
				valor = Tipos.real_para_cadeia(g_custo_total_galao_tinta)
				...
				valor = Tipos.real_para_cadeia(g_preco_unit_galao_tinta)
			...
			//Estruturas
				valor = Tipos.real_para_cadeia(g_profundidade_colunas)
				...
				valor = Tipos.real_para_cadeia(g_diametro_colunas)
				...
				valor = Tipos.real_para_cadeia(g_perimetro_total)
				...
				valor = Tipos.real_para_cadeia(g_larg_bald)
				...
				valor = Tipos.real_para_cadeia(g_prof_bald)
				...
				valor = Tipos.real_para_cadeia(g_area_total)
				...
				valor = Tipos.real_para_cadeia(g_qtde_cimento)
				...
				valor = Tipos.real_para_cadeia(g_alt_paredes)
				...
				valor = Tipos.real_para_cadeia(g_area_piso)
